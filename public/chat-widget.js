...
(function() {
  ...
  const CONFIG = {
    ...
    sessionUrl: '/api/session', // Cross-channel session transfer
    ttsUrl: '/api/tts', // ElevenLabs TTS API
    defaultLanguage: 'en',
  ...
  const LABELS = {
    ...
    ht: {
      ...
      welcome: 'Bonjou! Mwen se Asistan Vil Doral la. Mwen ka ede ou ak enfòmasyon sou sèvis minicpal yo, pèmi, evènman, pak ak plis ankò. Kijan mwen ka ede ou jodi a?',
      voiceOn: 'Vwa aktive',
