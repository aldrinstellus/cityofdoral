// Sentiment Analysis for City of Doral Chatbot
...
export function getEscalationMessage(language: 'en' | 'es' | 'ht'): string {
  if (language === 'es') {
    return 'Entiendo que puede estar frustrado. ¿Le gustaría hablar con un representante de la ciudad? Puede llamar al (305) 593-6725 o visitar City Hall en 8401 NW 53rd Terrace, Doral, FL 33166.';
  }
  if (language === 'ht') {
    return 'Mwen konprann ou ka fristre. Èske ou ta renmen pale ak yon reprezantan vil la? Ou ka rele (305) 593-6725 oswa vizite City Hall nan 8401 NW 53rd Terrace, Doral, FL 33166.';
  }
  return 'I understand you may be frustrated. Would you like to speak with a city representative? You can call (305) 593-6725 or visit City Hall at 8401 NW 53rd Terrace, Doral, FL 33166.';
}
