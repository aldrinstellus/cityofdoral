...
function formatViolationsResponse(property: TylerProperty): string {
  ...
  if (codeViolations.length === 0) {
    ...
    response += `This property is in compliance with City of Doral codes.`;
  } else {
...
function formatComprehensiveResponse(property: TylerProperty): string {
  ...
  response += `*Source: City of Doral Planning*\n\n`;
  ...
  response += `---\n\n`;
  response += `*This report was generated from Tyler Technologies Enterprise Suite integrated with City of Doral municipal systems.*`;
...
export async function handleTylerQuery(message: string): Promise<TylerQueryResult | null> {
  ...
  switch (queryType) {
    ...
    case 'permit-history':
      ...
      sources.push('Tyler EnerGov Permitting', 'City of Doral Building Department');
      relatedActions.push(
        { label: 'Apply for Permit', type: 'link', url: 'https://energovcss.cityofdoral.com' },
    ...
    case 'code-violations':
      ...
      sources.push('Tyler EnerGov Code Enforcement', 'City of Doral Code Compliance');
      relatedActions.push(
        { label: 'Report Violation', type: 'link', url: 'https://cityofdoral.com/311' },
    ...
    case 'zoning-info':
      ...
      sources.push('City of Doral Planning & Zoning', 'Miami-Dade Zoning');
      relatedActions.push(
        { label: 'Zoning Map', type: 'link', url: 'https://www.cityofdoral.com/Departments/Planning-and-Zoning-Department' },
    ...
    case 'comprehensive-report':
      ...
      sources.push(
        ...
        'City of Doral Records'
      );
      relatedActions.push(
        { label: 'Download Full Report (PDF)', type: 'workflow', workflowId: 'download-report' },
        { label: 'Request Official Records', type: 'link', url: 'https://www.cityofdoral.com/Government-Center/Office-of-the-City-Clerk/Public-Records-Request' },
      );
      break;
    ...
    default:
      ...
      sources.push('Tyler iasWorld Assessment', 'City of Doral Property Records');
      relatedActions.push(
