...
// "Doral" is pronounced as "dough-ral"
const MESSAGES = {
  en: {
    mainMenu: 'You can ask me questions about city services, permits, parks, and more. Press 1 at any time to speak with a representative. Press 2 to get a code to continue this conversation on our website. How can I help you today?',
    connecting: 'We are connecting you to a live agent. Please hold.',
    goodbye: 'Thank you for calling the City of Doral. Have a great day!',
    goodbyeSpoken: 'Thank you for calling the City of dough-ral. Have a great day!',
    ...
    transferCode: (code: string) => `I will give you a transfer code to continue this conversation on our website. Your code is: ${code}. I repeat, your code is: ${code}. Go to the City of Doral website, open the chat assistant, click the key icon, and enter this code. Your conversation will continue right where you left off.`,
    transferCodeSpoken: (code: string) => `I will give you a transfer code to continue this conversation on our website. ... Your code is: ${code}. ... I repeat, your code is: ${code}. ... Go to the City of dough-ral website, open the chat assistant, click the key icon, and enter this code. ... Your conversation will continue right where you left off.`,
  },
  es: {
    mainMenu: 'Puede hacerme preguntas sobre servicios de la ciudad, permisos, parques y más. Presione 1 en cualquier momento para hablar con un representante. Presione 2 para obtener un código para continuar esta conversación en nuestro sitio web. ¿En qué puedo ayudarle hoy?',
    connecting: 'Lo estamos conectando con un agente en vivo. Por favor espere.',
    goodbye: 'Gracias por llamar a la Ciudad de Doral. ¡Que tenga un buen día!',
    goodbyeSpoken: 'Gracias por llamar a la Ciudad de dough-ral. ¡Que tenga un buen día!',
    ...
    transferCode: (code: string) => `Le daré un código de transferencia para continuar esta conversación en nuestro sitio web. Su código es: ${code}. Repito, su código es: ${code}. Vaya al sitio web de la Ciudad de Doral, abra el asistente de chat, haga clic en el icono de llave e ingrese este código. Su conversación continuará donde la dejó.`,
    transferCodeSpoken: (code: string) => `Le daré un código de transferencia para continuar esta conversación en nuestro sitio web. ... Su código es: ${code}. ... Repito, su código es: ${code}. ... Vaya al sitio web de la Ciudad de dough-ral, abra el asistente de chat, haga clic en el icono de llave e ingrese este código. ... Su conversación continuará donde la dejó.`,
  },
  ht: {
    mainMenu: 'Ou ka poze m kesyon sou sèvis vil la, pèmi, pak, ak plis ankò. Peze 1 nenpòt ki lè pou pale ak yon reprezantan. Peze 2 pou jwenn yon kòd pou kontinye konvèsasyon sa a sou sit entènèt nou an. Kijan mwen ka ede w jodi a?',
    connecting: 'Nou ap konekte w ak yon ajan an dirèk. Tanpri tann.',
    goodbye: 'Mèsi paske w rele Vil Doral. Pase yon bon jounen!',
    goodbyeSpoken: 'Mèsi paske w rele Vil dough-ral. Pase yon bon jounen!',
    ...
    transferCode: (code: string) => `Mwen pral ba ou yon kòd transfè pou kontinye konvèsasyon sa a sou sit entènèt nou an. Kòd ou a se: ${code}. Mwen repete, kòd ou a se: ${code}. Ale sou sit entènèt Vil Doral la, ouvri asistan chat la, klike sou ikòn kle a epi antre kòd sa a. Konvèsasyon ou a pral kontinye kote ou te kite li.`,
    transferCodeSpoken: (code: string) => `Mwen pral ba ou yon kòd transfè pou kontinye konvèsasyon sa a sou sit entènèt nou an. ... Kòd ou a se: ${code}. ... Mwen repete, kòd ou a se: ${code}. ... Ale sou sit entènèt Vil dough-ral la, ouvri asistan chat la, klike sou ikòn kle a epi antre kòd sa a. ... Konvèsasyon ou a pral kontinye kote ou te kite li.`,
  },
};
...
export default function IVRDemoPage() {
  ...
  const startCall = async () => {
    ...
    const greetingDisplay = 'Hello! Welcome to the City of Doral. ' +
      'Press 1 for English. ' +
      'Para español, presione el dos. ' +
      'Pou Kreyòl Ayisyen, peze twa.';

    // Spoken version with phonetic "dough-ral" and natural pauses
    const greetingSpoken = 'Hello! Welcome to the City of dough-ral. ... ' +
      'Press 1, for English. ... ' +
      'Para español, presione el dos. ... ' +
      'Pou Kreyòl Ayisyen, peze twa.';
    ...
    // Display text shows "Doral", voice says "dough-ral"
    setTimeout(() => {
